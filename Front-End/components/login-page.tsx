      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="w-full bg-card rounded-xl shadow-md p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-2xl font-semibold text-center text-card-foreground flex-1 mr-8">Giriş Yap</h2>
          </div>
          ...
          <div className="text-center mt-6">
            <span className="text-muted-foreground">
              <Link href="/register" className="text-lilac hover:underline">
                Hesabınız yok mu? Kaydolun
              </Link>
            </span>
            <span className="block mt-2 text-muted-foreground">
              <Link href="/forgot-password" className="text-lilac hover:underline">
